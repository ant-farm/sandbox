...
CORS(listings, origins=['http://localhost:3000', 'https://sandbox-ator.herokuapp.com'], supports_credentials=True)
CORS(agents, origins=['http://localhost:3000', 'https://sandbox-ator.herokuapp.com'], supports_credentials=True)
